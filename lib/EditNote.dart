...
class EditNote extends StatefulWidget {
  final Note note; final Function del, add;
...
//  final Note nnn = hola;
  dynamic ipttitle; dynamic iptcontent;
  @override
  void initState() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(icon: Icon(Icons.delete, color: Colors.white,), onPressed: (){widget.del(widget.note.id); Navigator.of(context).pop();},),
          IconButton(icon: Icon(Icons.check, color: Colors.white,), onPressed: (){
            widget.del(widget.note.id); widget.add(Note(id: DateTime.now().toString(), title: ipttitle.text, text: iptcontent.text)); Navigator.of(context).pop();},),
        ],
      ),
      body: Container(
